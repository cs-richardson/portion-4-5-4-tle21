...
# How much food each person is supposed to get
tons_of_food_per_person = tons_of_food / num_people
print (round(tons_of_food_per_person,5))

# Ask the user how much food they took
tons_taken = float(input("How many tons of food did you take? "))
if round(tons_taken,5) == round(tons_of_food_per_person,5): #Rounded to 5 decimal places
